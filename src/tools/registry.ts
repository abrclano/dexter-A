...
export function getToolRegistry(model: string): RegisteredTool[] {
  ...
  if (process.env.TUSHARE_API_KEY) {
    tools.push({
      ...
      compactDescription: 'Search Chinese A-share market data via Tushare.',
      concurrencySafe: true,
    });
  }
    ...
    tools.push(
      {
        ...
        compactDescription: 'Fetch A-share financial data via Eastmoney/MX API.',
        concurrencySafe: true,
      },
      {
        ...
        compactDescription: 'Search A-share news and announcements via Eastmoney/MX API.',
        concurrencySafe: true,
      },
      {
        ...
        compactDescription: 'Screen A-share stocks by financial criteria via Eastmoney.',
        concurrencySafe: true,
      },
      {
        ...
        compactDescription: 'Manage Eastmoney self-selected stock watchlist.',
        concurrencySafe: true,
      },
      {
        ...
        compactDescription: 'Simulate A-share stock trading via Eastmoney.',
        concurrencySafe: false,
      },
    );
  }
