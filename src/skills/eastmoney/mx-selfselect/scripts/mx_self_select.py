...
def main():
    ...
    parser.add_argument("--output-dir", dest="output_dir", help=f"输出目录，默认 {Path('.dexter/mx_data/output')}")

    args = parser.parse_args()

    # Default output directory
    default_output = Path(".dexter/mx_data/output")
